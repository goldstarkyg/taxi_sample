...
class Controller_TaximobilityError extends Controller_Siteadmin
{
    /**
     * @var string
     */
    ...
    public function action_404()
    {
        ...
        $this->view                  = View::factory( 'error/404' )->set( 'error_message', $this->_message )->set( 'requested_page', $this->_requested_page );
    }
    /**
