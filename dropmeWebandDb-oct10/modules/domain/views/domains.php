                ...
                <div class="account_rgt_det">
                    <div class="rgt_lay sms_lay">
                        <div class="primary_domain_det">
                            ...
                            <div class="small_sel">
                                <select class="form_control" name="primary_domain" id="primary_domain">
...
<!--                            <div class="traffic_redirect">
                     ...
                     <div class="bottom_butt_sec">
                         <div class="align_right" id="btn_save_redirect" style="display: none">
                    ...
                    <div class="rgt_lay">
                        <div class="table_wrapper domain_list">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td><span><?php echo $live_domain_name;?></span></td>
                                    ...
                                    <tr>
                                        <td><span><a href="#"><?php echo $live_host_domain_name;?></a></span>
                                            <input type="hidden" name="hid_domain_name" id="hid_domain_name" value="<?php echo $live_host_domain_name;?>"</td>
                                        ...
                                        <td class="tr"><a class="del_ico" href="<?php echo URL_BASE;?>domain/domain_delete" onclick="return confirm_delete();"><svg role="img" viewBox="0 0 408.483 408.483" class="icon_12"><g><use xlink:href="#delete" class="icon_12"></use></g></svg></a></td>
                                    </tr>
<!--                                    <tr class="no-border">
...
<div class="ui_footer_help">
    <div class="ui_footer_help_content">
        ...
        <div><p>Need help? Go to the DropMe  Domains Manual<!--<a href="#" target="_blank">Domains Manual</a>!--></p></div>
    </div>
</div>
...
$.ajax({
			...
			success:function(data){                            
                           ...
                           if(obj.dns_status==1){
                               ...
                               $('.setup_status').html('');
                               $('#btn_save_redirect').show();
                               $('#primary_domain').html('');
                               $('#primary_domain').html('<option value="<?php echo $live_domain_name;?>" selected="selected"><?php echo $live_domain_name;?></option><option value="<?php echo $live_host_domain_name;?>"><?php echo $live_host_domain_name;?></option>');
                           }else{
                               $('.domain-status').html('');
                               $('.domain-status').html('<span class="domain_sta">Setup required</span>');
                               $('.setup_status').html('');
                               $('.setup_status').html('<a class="complete_setup" href="<?php echo URL_BASE;?>domain/domain_connect">Complete setup</a>');
                               $('#btn_save_redirect').hide();
                               $('#primary_domain').html('');
                               $('#primary_domain').html('<option value="<?php echo $live_domain_name;?>" selected="selected"><?php echo $live_domain_name;?></option>');
                           }
