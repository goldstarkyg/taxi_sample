...
<div class="domains_card_width_limit">
    <div class="rgt_lay">
        ...
        <div class="pay_card_det">
            <input type="text" value="<?php echo $live_host_domain_name;?>" class="form_control" name="domain_name" id="domain_name" placeholder="e.g.example.com"/>
...
<div class="ui_footer_help">
    <div class="ui_footer_help_content">
        ...
        <div><p>Learn more about domains<!--<a href="#">domains</a>!--> at the Taximobility Help Center.</p></div>
    </div>
</div>
