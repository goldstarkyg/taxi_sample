	...
	_limitMinMaxDateTime: function(dp_inst, adjustSliders){
		...
		if(this._defaults.minDateTime !== null && dp_date){
			var minDateTime = this._defaults.minDateTime,
				minDateTimeDate = new Date(minDateTime.getFullYear(), minDateTime.getMonth(), minDateTime.getDate(), 0,minDateTime.getHours(), minDateTime.getMinutes(), minDateTime.getSeconds());
		...
		if(this._defaults.maxDateTime !== null && dp_date){
			var maxDateTime = this._defaults.maxDateTime,
				maxDateTimeDate = new Date(maxDateTime.getFullYear(), maxDateTime.getMonth(), maxDateTime.getDate(), 0, maxDateTime.getHours(), maxDateTime.getMinutes(), maxDateTime.getSeconds());
