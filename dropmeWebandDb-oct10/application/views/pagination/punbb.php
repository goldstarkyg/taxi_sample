...
<div class="new_pagination">
   ...
   <ul class="fr">
      ...
      <li>
         <a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first" title="<?php echo __('first') ?>"><?php echo __('first') ?></a>
      </li>
      <?php else: ?>
      <li>
         <p title="<?php echo __('first') ?>"><?php echo __('first') ?></p>
      </li>
      <?php endif ?>
      ...
      <li>
         ...
         <a href="<?php echo HTML::chars($page->url($last_page)) ?> " rel="last" title="<?php echo __('last') ?>">
         <?php echo __('last') ?>
         </a> 
      </li>
      <?php else: ?>
      <li>
         <p title="<?php echo __('last') ?>"><?php echo __('last') ?></p>
      </li>
      <?php endif ?>
   </ul>
</div>
