...
<div class="loginWrapper">
    ...
    <div class="login_box">
        <div class="title"><h6><?php echo __('forgot_password'); ?></h6></div>
        <?php
        //For Notice Messages
        //===================
...
<?php if (isset($error_login)) { ?><span class="login_error"><?php echo $error_login; ?></span><?php } ?>
        <form class="form_login" method="post" name="frmlogin" id="frmlogin">
            ...
            <div class="loginControl">
                <?php /* <div class="rememberMe"><a href="<?php echo URL_BASE; ?>admin/login" class="frgtpsd"><?php echo ucfirst(__('login')); ?></a></div> */?>
