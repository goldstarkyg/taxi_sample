...
<thead>
	...
	<td align="left" style="text-align:left;" width="15%"><?php echo __('country_label').' '.__('name_label'); ?></td>
	<td align="left" style="text-align:left;" width="15%"><?php echo __('iso_code'); ?></td>
	<td align="left" style="text-align:left;" width="11%"><?php echo __('telephone_code'); ?></td>
	<td align="left" style="text-align:left;" width="10%"><?php echo __('currency_code'); ?></td>
	...
	<tbody>
		...
		/* For Serial No */
		$sno=$Offset;
		//echo "<pre>"; print_r($all_company_list); exit;
		...
		<tr class="<?php echo $trcolor; ?>">
			...
			<td align="center"><?php echo '<a href='.URL_BASE.'edit/country/'.$listings['country_id'].' " title ="'.__("edit").'" class="editicon"></a>' ; ?></td>
		...
		if($sno > 1){ ?>
			<tr>				
				<td colspan="10" align="right"><div class="new_button"><input type="submit" name="update" title="<?php echo __('button_update');?>" value="<?php echo __('button_update');?>" /></div></td>
			</tr>   
		<?php } /*else { ?>
			<tr>
...
<?php if(count($all_company_list) > 1)
       { ?>
