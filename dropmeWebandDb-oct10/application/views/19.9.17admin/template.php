...
<html>
	...
	?>
	<?php
	$alert_message = array('email_exists' => __('email_exists'), 'phone_exists' => __('phone_exists'));
...
<?php if(isset($_SESSION['user_type']) && $_SESSION['user_type']=='A' && LIVECHATSTATUS==1) {  ?>
<script type="text/javascript">
window.__lc = window.__lc || {};
window.__lc.license = 1098049;
(function() {
