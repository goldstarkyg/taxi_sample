<h1><strong><?php echo __('500_error'); ?></strong> <?php echo __('internalserver_error'); ?></h1>
...
<p>This incident is logged and we are already notified about this problem. We will trace the cause of this problem.</p>
