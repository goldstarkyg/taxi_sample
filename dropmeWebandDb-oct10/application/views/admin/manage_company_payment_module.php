...
<thead>
	...
	<tbody>
		...
		<tr class="<?php echo $trcolor; ?>">
			...
			<td align="center" width="20"><?php echo '<a href='.URL_BASE.'edit/paymentgateway/'.$listings['id'].' " title ="'.__("edit").'" class="editicon"></a>' ; ?></td>
		...
		?>
			<tr>
				...
				<td colspan="8" align="right"><div class="button blackB"><input type="submit" name="update" value="<?php echo __('button_update');?>" value="<?php echo __('button_update');?>" /></div></td>
			</tr>   
		<?php }else { ?>
			<tr>
