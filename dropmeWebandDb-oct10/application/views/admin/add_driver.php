...
<div class="container_content fl clr">
	...
	<tr>
	<td width="25%"><label><?php echo __('total_due_amount_mobile'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
			<input type="text"  maxlength="45"  title="<?php echo __('total_due_amount_mobile'); ?>" id="total_due_amount_mobile" name="total_due_amount_mobile" value="<?php if(isset($postvalue) && array_key_exists('total_due_amount_mobile',$postvalue)){ echo $postvalue['total_due_amount_mobile']; }?>" />
	...
	<tr>
	<td width="25%"><label><?php echo __('daily_deduction_amount'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
			<input type="text"  maxlength="45"  title="<?php echo __('enter_daily_deduction_amount'); ?>" id="daily_deduction_amount" name="daily_deduction_amount" value="<?php if(isset($postvalue) && array_key_exists('daily_deduction_amount',$postvalue)){ echo $postvalue['daily_deduction_amount']; }?>" />
	...
	<tr>
	<td width="25%"><label><?php echo __('insurance_total_due_amount'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
			<input type="text"  maxlength="45"  title="<?php echo __('enter_insurance_total_due_amount'); ?>" id="insurance_total_due_amount" name="insurance_total_due_amount" value="<?php if(isset($postvalue) && array_key_exists('insurance_total_due_amount',$postvalue)){ echo $postvalue['insurance_total_due_amount']; }?>" />
	...
	<tr>
	<td width="25%"><label><?php echo __('insurance_daily_deduction_amount'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
			<input type="text"  maxlength="45"  title="<?php echo __('enter_insurance_daily_deduction_amount'); ?>" id="insurance_daily_deduction_amount" name="insurance_daily_deduction_amount" value="<?php if(isset($postvalue) && array_key_exists('insurance_daily_deduction_amount',$postvalue)){ echo $postvalue['insurance_daily_deduction_amount']; }?>" />
	...
	<tr>
	<td width="25%"><label><?php echo __('wallet_amount'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
			<input type="text"  maxlength="45"  title="<?php echo __('enter_wallet_amount'); ?>" id="wallet_amount" name="wallet_amount" value="<?php if(isset($postvalue) && array_key_exists('wallet_amount',$postvalue)){ echo $postvalue['wallet_amount']; }?>" />
	...
	<tr>
	<td width="25%"><label><?php echo __('transaction_id'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
	...
	<tr>
	<td width="25%"><label><?php echo __('reference_number'); ?></label><span class="star">*</span></td>
	<td>
		<div class="new_input_field">
