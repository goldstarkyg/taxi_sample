...
//print_r($driver_info_details);exit();
?>
...
<?php 
	...
	if(isset($driver_info_details[0]['total_due_amount_mobile']) && !array_key_exists('total_due_amount_mobile',$postvalue)){
		$total_due_amount_mobile = $driver_info_details[0]['total_due_amount_mobile'];
	}else{
		if(isset($postvalue['total_due_amount_mobile'])){
			$total_due_amount_mobile = $postvalue['total_due_amount_mobile'];
		}else{
			$total_due_amount_mobile = "";
		}
	}

	if(isset($driver_info_details[0]['wallet_amount']) && !array_key_exists('wallet_amount',$postvalue)){
		$wallet_amount = $driver_info_details[0]['wallet_amount'];
	}else{
		if(isset($postvalue['wallet_amount'])){
			$wallet_amount = $postvalue['wallet_amount'];
		}else{
			$wallet_amount = "";
		}
	}

	if(isset($driver_info_details[0]['daily_deduction_amount']) && !array_key_exists('daily_deduction_amount',$postvalue)){
		$daily_deduction_amount = $driver_info_details[0]['daily_deduction_amount'];
	}else{
		if(isset($postvalue['daily_deduction_amount'])){
			$daily_deduction_amount = $postvalue['daily_deduction_amount'];
		}else{
			$daily_deduction_amount = "";
		}
	}
	//print_r($driver_info_details);exit;
	if(isset($driver_info_details[0]['insurance_total_due_amount']) && !array_key_exists('insurance_total_due_amount',$postvalue)){
		$insurance_total_due_amount = $driver_info_details[0]['insurance_total_due_amount'];
	}else{
		if(isset($postvalue['insurance_total_due_amount'])){
			$insurance_total_due_amount = $postvalue['insurance_total_due_amount'];
		}else{
			$insurance_total_due_amount = "";
		}
	}

	if(isset($driver_info_details[0]['insurance_daily_deduction_amount']) && !array_key_exists('insurance_daily_deduction_amount',$postvalue)){
		$insurance_daily_deduction_amount = $driver_info_details[0]['insurance_daily_deduction_amount'];
	}else{
		if(isset($postvalue['insurance_daily_deduction_amount'])){
			$insurance_daily_deduction_amount = $postvalue['insurance_daily_deduction_amount'];
		}else{
	...
	<tr>
	<td valign="top" width="25%"><label><?php echo __('total_due_amount_mobile'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_total_due_amount_mobile'); ?>" id="total_due_amount_mobile" name="total_due_amount_mobile" value="<?php echo $total_due_amount_mobile; ?>" />
              <?php if(isset($errors) && array_key_exists('total_due_amount_mobile',$errors)){ echo "<span class='error'>".ucfirst($errors['total_due_amount_mobile'])."</span>";}?>
	</div>
	</td>
        </tr>

    <tr>
	<td valign="top" width="25%"><label><?php echo __('daily_deduction_amount'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_daily_deduction_amount'); ?>" id="daily_deduction_amount" name="daily_deduction_amount" value="<?php echo $daily_deduction_amount; ?>" />
              <?php if(isset($errors) && array_key_exists('daily_deduction_amount',$errors)){ echo "<span class='error'>".ucfirst($errors['daily_deduction_amount'])."</span>";}?>
	</div>
	</td>
        </tr>

    <tr>
	<td valign="top" width="25%"><label><?php echo __('insurance_total_due_amount'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_insurance_total_due_amount'); ?>" id="insurance_total_due_amount" name="insurance_total_due_amount" value="<?php echo $insurance_total_due_amount; ?>" />
              <?php if(isset($errors) && array_key_exists('insurance_total_due_amount',$errors)){ echo "<span class='error'>".ucfirst($errors['insurance_total_due_amount'])."</span>";}?>
	</div>
	</td>
        </tr>

    <tr>
	<td valign="top" width="25%"><label><?php echo __('insurance_daily_deduction_amount'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('insurance_daily_deduction_amount'); ?>" id="insurance_daily_deduction_amount" name="insurance_daily_deduction_amount" value="<?php echo $insurance_daily_deduction_amount; ?>" />
              <?php if(isset($errors) && array_key_exists('insurance_daily_deduction_amount',$errors)){ echo "<span class='error'>".ucfirst($errors['insurance_daily_deduction_amount'])."</span>";}?>
	</div>
	</td>
        </tr>
...
<?php 
if($wallet_amount < 0){
$amt = explode('-', $wallet_amount);

}
$amut = 0;
//print_r($amt[1]); ?>
   <tr>
	<td valign="top" width="25%"><label><?php echo __('wallet_amount'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_wallet_amount'); ?>" id="wallet_amount" name="wallet_amount" value="<?php //echo $wallet_amount; ?>" />
              <?php if(isset($errors) && array_key_exists('wallet_amount',$errors)){ echo "<span class='error'>".ucfirst($errors['wallet_amount'])."</span>";}?>
              <?php if($wallet_amount < 0){ ?>
    <small class="sub_note"><?php  echo 'Available wallet amount : '.$amut.', Outstanding amount'.$amt[1] ; ?></small>
    <?php } else { ?>
    <small class="sub_note"><?php  echo 'Available wallet amount : '.$wallet_amount.', Outstanding amount : '.$amut ; ?></small>
    <?php }  ?>
	</div>
	</td>
        </tr>
     ...
     <tr>
	<td valign="top" width="25%"><label><?php echo __('transaction_id'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_transaction_id'); ?>" id="transaction_id" name="transaction_id" value="" />
              <?php if(isset($errors) && array_key_exists('transaction_id',$errors)){ echo "<span class='error'>".ucfirst($errors['transaction_id'])."</span>";}?>
	</div>
	</td>
        </tr>

     <tr>
	<td valign="top" width="25%"><label><?php echo __('reference_number'); ?></label><span class="star">*</span></td>        
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="45" title="<?php echo __('enter_reference_number'); ?>" id="reference_number" name="reference_number" value="" />
              <?php if(isset($errors) && array_key_exists('reference_number',$errors)){ echo "<span class='error'>".ucfirst($errors['reference_number'])."</span>";}?>
	</div>
	</td>
        </tr>
