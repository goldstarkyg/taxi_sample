...
//print_r($site[0]['insurance_amount']);exit();
    ...
    <div class="cont_container mt15 mt10">
       <div class="content_middle">
           <div class="driverinfo_common">
			...
			<?php if(isset($user_details1[0]['total_due_amount_mobile']) && !empty($user_details1[0]['total_due_amount_mobile'])) { ?> 
			<li><label><?php echo __('total_due_amount_mobile'); ?></label>
                            <p><?php if(isset($user_details1[0]['total_due_amount_mobile'])) { echo $user_details1[0]['total_due_amount_mobile']; } ?></p>
				   </li> 
			<?php } ?>

			<?php if(isset($user_details1[0]['daily_deduction_amount']) && !empty($user_details1[0]['daily_deduction_amount'])) { ?> 
			<li><label><?php echo __('daily_deduction_amount'); ?></label>
                            <p><?php if(isset($user_details1[0]['daily_deduction_amount'])) { echo $user_details1[0]['daily_deduction_amount']; } ?></p>
				   </li> 
			<?php } ?>

			<?php if(isset($user_details1[0]['daily_deduction_amount']) &&isset($user_details1[0]['total_due_amount_mobile']) && !empty($user_details1[0]['daily_deduction_amount']) && !empty($user_details1[0]['total_due_amount_mobile'])) { ?> 
			<li><label><?php echo __('total_balance_amount'); ?></label>
                            <p><?php  echo $user_details1[0]['total_due_amount_mobile']-$user_details1[0]['daily_deduction_amount'];  ?></p>
				   </li> 
			<?php } ?>

			<?php if(isset($user_details1[0]['insurance_total_due_amount']) && !empty($user_details1[0]['insurance_total_due_amount'])) { ?> 
			<li><label><?php echo __('insurance_total_due_amount'); ?></label>
                            <p><?php if(isset($user_details1[0]['insurance_total_due_amount'])) { echo $user_details1[0]['insurance_total_due_amount']; } ?></p>
				   </li> 
			<?php } ?>

			<?php if(isset($user_details1[0]['insurance_daily_deduction_amount']) && !empty($user_details1[0]['insurance_daily_deduction_amount'])) { ?> 
			<li><label><?php echo __('insurance_daily_deduction_amount'); ?></label>
                            <p><?php if(isset($user_details1[0]['insurance_daily_deduction_amount'])) { echo $user_details1[0]['insurance_daily_deduction_amount']; } ?></p>
				   </li> 
			<?php } ?>

			<?php if(isset($site[0]['insurance_amount']) && !empty($site[0]['insurance_amount'])) { ?> 
			<li><label><?php echo __('insurance_amount'); ?></label>
                            <p><?php if(isset($site[0]['insurance_amount'])) { echo $site[0]['insurance_amount']; } ?></p>
				   </li> 
			<?php } ?>
								...
								<tr class="<?php echo $class; ?>">	
									...
									<td>
										<div class="new_button">
											<input type="button" class="complete_trip" id="<?php echo $values->trip_id.'|'.$values->taxi_id; ?>" value="<?php echo __('complete_trip') ?>">
										</div>
									</td>
								</tr>
...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		<div class="title"><h6><?php echo __('manage_driver_wallet'); ?></h6>
...
<div class="over_all">
    <div class="widget" style="margin-bottom:0px !important;">
		<div class="title"><h6><?php echo __('mobile_deduction_logs'); ?></h6>
	</div>
</div>  
<?php 
	 if($mobile_deduction_logs_count > 0)
	 { 
	 	?>
			<div class= "overflow-block">
		<?php 
	...
	{ 
		?>
			<thead>
			    <tr >
					<td align="center" width="5%"><?php echo __('sno_label'); ?></td>
					<td align="center" width="5%"><?php echo __('total_amount'); ?></td>
					<td align="left" width="15%"><?php echo __('deduct_amount'); ?></td>
					<td align="left" width="15%"><?php echo __('balance_amount'); ?></td>
					<td align="left" width="15%"><?php echo __('date'); ?></td> 
			    </tr>
			</thead>
	        <tbody>
			<?php
				$sno = $Offset; /* For Serial No */
				foreach($driver_mobile_deduction_logs as $req_list) 
				{			 
					//S.No Increment
					//==============
					$sno++;
					...
					<tr class="<?php echo $trcolor; ?>">
						<td align="center"><?php echo $sno; ?></td>
						<td align="left"><?php echo $req_list['total_amount_mobile']; ?></td>
						<td align="left"><?php echo $req_list['mobile_deduct_amount']; ?></td>
						<td  align="left"><?php echo $req_list['balance_amount_mobile']; ?></td>
						<td  align="left"><?php echo $req_list['log_date']; ?></td>
					</tr>
				<?php 
			} 
 		} 
...
<div class="bottom_contenttot">
<div class="pagination">
		<?php if($mobile_deduction_logs_count > 0): ?>
		 <?php echo $pag_data_mobile->render(); ?>
		<?php endif; ?> 
  </div>
 </div>

 <!--Insurance Deduction Logs-->
 <div class="over_all">
    <div class="widget" style="margin-bottom:0px !important;">
		<div class="title"><h6><?php echo __('insurance_deduction_logs'); ?></h6>
	</div>
</div>  
<?php 
	 if($insurance_deduction_logs_count > 0)
	 { 
	 	?>
			<div class= "overflow-block">
		<?php 
...
<?php 
	...
	{ 
		?>
			...
			<?php
				$sno = $Offset; /* For Serial No */
				foreach($driver_insurance_deduction_logs as $req_list) 
				{			 
					//S.No Increment
					//==============
					$sno++;
					...
					<tr class="<?php echo $trcolor; ?>">
						<td align="center"><?php echo $sno; ?></td>
						<td align="left"><?php echo $req_list['insurance_total_amount']; ?></td>
						<td align="left"><?php echo $req_list['insurance_deduct_amount']; ?></td>
						<td  align="left"><?php echo $req_list['balance_insurance_amount']; ?></td>
						<td  align="left"><?php echo $req_list['log_date']; ?></td>
					</tr>
				<?php 
			} 
...
<div class="bottom_contenttot">
<div class="pagination">
		<?php if($insurance_deduction_logs_count > 0): ?>
		 <?php //echo $pag_data_insurance->render(); ?>
		<?php endif; ?> 
  </div>
 </div>
...
<form action="<?php echo URL_BASE ?>manage/complete_trip" id="completeTrip" method="post" name="complete"> 
    <ul>
        <li>
            <label><?php echo __('Drop_Location'); ?></label>
            <b>:</b>
            <div class="input_box">
                <input type="text" placeholder="<?php echo __('enter_drop_locations') ?>" name="drop_location" id="drop_location" autocomplete="off">	
         ...
         <li>
            ...
            <b>:</b>
            <div class="input_box">
                <input type="text"  name="distance" id="distance" autocomplete="off" maxlength="6">
            </div>
        </li>
        <li>
            ...
            <b>:</b>
            <div class="input_box">
                <input type="text"  name="trip_fare" id="trip_fare" maxlength="9">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$( ".complete_trip" ).live( "click", function() {
			//~ $('.export_me_menu').hide();
			var trip_taxiid = this.id.split('|');
			tripid = trip_taxiid[0];
			taxiid = trip_taxiid[1];
		...
		$("#distance").keyup(function(){
			...
			var dataS = "&tripId="+tripId+"&taxiId="+taxiId+"&distance="+distance;
			var SrcPath = "<?php echo URL_BASE; ?>";
			var response;
			$.ajax
			({ 			
