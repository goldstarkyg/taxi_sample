...
<input type="text" name="tax" id="tax"  title="<?php echo __('enter_tax'); ?>" maxlength="5" value="<?php echo isset($site_settings) && (!array_key_exists('tax', $errors)) ? $site_settings[0]['tax'] : $validator['tax']; ?>">
            ...
            <tr>
            	<td valign="top" width="20%"><label><?php echo __('insurance_amount'); ?></label><span class="star">*</span></td>
            	<td><div class="new_input_field">
            	<input type="text" name="insurance_amount" id="insurance_amount" title="<?php echo __('enter_insurance_amount'); ?>" maxlength="10"  value="<?php echo isset($site_settings) && (!array_key_exists('insurance_amount', $errors)) ? $site_settings[0]['insurance_amount'] : $validator['insurance_amount']; ?>" ></div>
            	 <span class="error"><?php echo isset($errors['insurance_amount']) ? ucfirst($errors['insurance_amount']) : ''; ?></span>
            </tr>
