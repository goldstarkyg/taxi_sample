...
<footer class="footer">
   ...
   <ul>
      <li>
         <a target="_blank" href="<?php echo $home_array['facebook_follow_link']; ?>" title="<?php echo __('facebook'); ?>" class="face_footer"></a>
      </li>
      <li>
         <a target="_blank" href="<?php echo $home_array['twitter_follow_link']; ?>" title="<?php echo __('twitter'); ?>" class="tweet_footer"></a>
      </li>
      <li>
         <a target="_blank" href="<?php echo $home_array['google_follow_link']; ?>" title="<?php echo __('google_plus'); ?>" class="gplus_footer"></a>
      </li>
   </ul>
</div>
...
<?php } ?>
<div id="fade"></div>
<a id="backTop" class="white">&nbsp;</a>

<script src="<?php echo URL_BASE; ?>public/common/js/landing_page/jquery.backTop.min.js"></script>
<script>
   $(document).ready( function() {
		$('#backTop').backTop({
           'position' : 1600,
