	...
	<section id="right_side_part">
		<div class="top_part">
			<div class="bread_com">
				<ul>
					...
					<li><p><?php echo __("add_card_details"); ?></p></li>
				</ul>
			</div>
		...
		<div class="white_bg">
			<div class="completed_trips cancelled_trip">
				<h2><?php echo __("add_card_details"); ?></h2>
				<div class="card_details">
					<form name="payment_option_form" method="post" autocomplete="off" onsubmit="return validate_payment_option_form();">
						<ul>
							...
							<li class="card_no">
								<input type="text" class="credit_card_number" x-autocompletetype="cc-number" placeholder="<?php echo __("credit_card_no"); ?>" name="creditcard_number" onpaste="return false;" value="">
								<em id="credit_card_error"></em>
							</li>
							<li class="cal_month" style="margin-left: 0;">
								<input type="text" class="credit_card_expiry" x-autocompletetype="cc-exp" placeholder="<?php echo __("mm_yyyy"); ?>" maxlength="9" onpaste="return false;" name="creditcard_expiry_date" value="">
								<em id="credit_card_expiry_error"></em>
							</li>
							<li class="cvv">
								<input type="text" class="credit_card_cvc" maxlength="4" x-autocompletetype="cc-csc" placeholder="<?php echo __("card_verification_no"); ?>" autocomplete="off" onpaste="return false;" name="creditcard_cvv" value="">
