...
<!--	<a href="javascript:;" class="close_butt">&nbsp;</a>-->
	...
	<form name="signupForm" method="post" enctype="multipart/form-data">
		...
		<ul>
			...
			<?php /* ?><li><label>Card</label></li>
			<li><div class="full_name"><input type="text" name="credit_card_number" class="credit_card_number" x-autocompletetype="cc-number" id="credit_card_number" maxlength="20" tabindex="10" value="5200 0000 0000 0080" placeholder="<?php echo __('credit_card_no'); ?>*" readonly/></div></li>
			<li><div class="month"><input type="text" name="month" id="month" maxlength="2" tabindex="11" value="12" placeholder="<?php echo __('month'); ?>*" readonly/></div>
			...
			<li><div class="full_name"><input type="text" name="cvv" id="cvv" maxlength="4" tabindex="13" value="123" placeholder="<?php echo __('CVV'); ?>*" readonly/></div></li>
			 <?php */ ?> <?php } ?>
